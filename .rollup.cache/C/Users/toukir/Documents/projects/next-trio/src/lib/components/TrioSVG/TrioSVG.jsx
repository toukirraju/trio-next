...
const TrioSVG = ({ svg, stroke, fill, width, height }) => {
    if (typeof svg === "string") {
        return (<StringSVG svg={svg} stroke={stroke} fill={fill} width={width} height={height}/>);
    }
    return (<SVGComponent svg={svg} stroke={stroke} fill={fill} width={width} height={height}/>);
};
...
//# sourceMappingURL=TrioSVG.jsx.map