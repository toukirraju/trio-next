...
export var textareaVariants = cva('relative inline-flex w-full max-w-full items-center font-sans text-sm disabled:opacity-50 disabled:cursor-not-allowed px-3 py-2 leading-snug outline-none transition-all duration-300 focus:outline-none', {
    variants: {
        color: {
