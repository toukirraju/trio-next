...
export const tagVariants = cva('relative inline-flex h-7 items-center justify-center font-sans whitespace-nowrap px-3 text-center text-xs gap-1 leading-10 transition-all duration-300', {
    variants: {
        color: {
            default: "",
            contrast: "",
    ...
    compoundVariants: [
        {
            variant: 'solid',
            color: 'default',
            className: 'border border-muted-200 dark:border-muted-700 bg-white dark:bg-muted-800 text-muted-500 dark:text-muted-100'
        },
        {
            variant: 'solid',
            color: 'contrast',
            className: 'border border-muted-200 dark:border-muted-800 bg-white dark:bg-muted-950 text-muted-500 dark:text-muted-100'
        },
        {
            variant: 'solid',
            color: 'muted',
...
//# sourceMappingURL=tag-variants.js.map