...
export var tagVariants = cva('relative inline-flex h-7 items-center justify-center font-sans whitespace-nowrap px-3 text-center text-xs gap-1 leading-10 transition-all duration-300', {
    variants: {
        color: {
            default: "",
            contrast: "",
