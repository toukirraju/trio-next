...
export const inputVariants = cva("relative w-full leading-tight font-sans disabled:opacity-50 disabled:cursor-not-allowed outline-none transition-all duration-300", {
    variants: {
        color: {
