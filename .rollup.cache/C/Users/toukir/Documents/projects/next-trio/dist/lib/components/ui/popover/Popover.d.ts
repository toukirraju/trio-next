...
export declare function usePopover({ initialOpen, placement, modal, open: controlledOpen, onOpenChange: setControlledOpen, indicatorArrow, offsetDistance, }?: PopoverOptions): {
